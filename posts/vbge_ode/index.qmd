...
$$L_t=L_\infty(1-\exp(-K(t-t_0)))$$ And this is the version most fisheries biologists are familiar with. It's the most common model for describing length as a function of age, very likely because it was adopted by Beverton and Holt [-@bevertonDynamicsExploitedFish1957]. von Bertalanffy [-@vonbertalanffyLawsMetabolismGrowth1957] writes:
